(() => {
  ...
  const translations = {
    ru: {
      ...
      "order.step1.text": "Свяжитесь с нами любым удобным способом — подскажем сорт, наличие и стоимость.",
      "order.step2.title": "Доставка или самовывоз",
      "order.step2.text": "Получите свежий мёд с доставкой или заберите заказ при встрече.",
      "contacts.title": "КОНТАКТЫ",
      "contacts.lead": "С радостью ответим на ваши вопросы и подберём удобный способ получения.",
      "contacts.city1": "Кишинёв",
      "contacts.city2": "Дондюшаны",
      "contacts.pickup": "Самовывоз / точка выдачи",
      "contacts.phone1.aria": "Позвонить в Кишинёв: +373 69 396 624",
    ...
    ro: {
      ...
      "mobile.nav.order": "Cum să comanzi",
      "mobile.nav.contacts": "Contacte",
      "hero.title.small": "NATURALĂ",
      "hero.title.big": "MIERE",
      ...
      "order.step2.text": "Primiți miere proaspătă prin livrare sau ridicare personală.",
      "contacts.title": "CONTACTE",
      "contacts.lead": "Vă răspundem cu drag la întrebări și vă ajutăm să alegeți cea mai convenabilă metodă de primire.",
      "contacts.city1": "Chișinău",
      "contacts.city2": "Dondușeni",
      "contacts.pickup": "Ridicare / punct de preluare",
      "contacts.phone1.aria": "Sunați la Chișinău: +373 69 396 624",
      "contacts.phone2.aria": "Sunați la Dondușeni: +373 69 494 508",
